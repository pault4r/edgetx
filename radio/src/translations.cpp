...
const char STR_PWR_OFF_IF_INACTIVE[]  = TR_PWR_OFF_IF_INACTIVE;
const char STR_ON_DELAY[]  = TR_ON_DELAY;
const char STR_OFF_DELAY[]  = TR_OFF_DELAY;
const char STR_AUTO_OFF[]  = TR_AUTO_OFF;
